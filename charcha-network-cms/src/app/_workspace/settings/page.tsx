      ...
      <div className="flex-1 max-w-2xl p-4 md:p-6" style={{ paddingLeft: 'max(16px, env(safe-area-inset-left))', paddingRight: 'max(16px, env(safe-area-inset-right))' }}>
            ...
            <>
              ...
              <div style={{ marginBottom: 16 }}>
                ...
                <p style={{ fontSize: 11, color: 'var(--text-muted)', margin: '0 0 8px', lineHeight: 1.45 }}>
                  ...
                  . One line per key; requests rotate across keys. Leave empty for local{' '}
                  <code style={{ fontSize: 11 }}>ollama serve</code>. Paste below to replace stored keys.
                </p>
        ...
        {isCmsRoute && (
          <p style={{ marginTop: 16, fontSize: 12, color: 'var(--text-muted)', lineHeight: 1.5 }}>
            WordPress publishing and field mapping are configured in{' '}
            <strong style={{ color: 'var(--text)' }}>Studio</strong> (dashboard), not in this CMS.
          </p>
        )}
      </div>
    </div>
