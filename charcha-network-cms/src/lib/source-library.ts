...
const ENGLISH_SOURCES: LibrarySource[] = [
  ...
  // ─── Official government / state media (RSS) — US, India, Russia, Iran ─────
  // If a feed fails from your server (403/geo), try “Add” manually or use HTML listing from the site’s news index.
  { name: 'White House — News', url: 'https://www.whitehouse.gov/news/feed/', channel: 'US Govt', category: 'Government', language: EN, type: R },
  { name: 'US DoD — Defense News', url: 'https://www.defense.gov/DesktopModules/ArticleCS/RSS.ashx?ContentType=1&Site=945', channel: 'US Govt', category: 'Government', language: EN, type: R },
  { name: 'US DOJ — Justice News', url: 'https://www.justice.gov/news/rss', channel: 'US Govt', category: 'Government', language: EN, type: R },
  { name: 'NASA — Breaking news', url: 'https://www.nasa.gov/rss/dyn/breaking_news.rss', channel: 'US Govt', category: 'Government', language: EN, type: R },
  { name: 'PIB India — Press releases (English)', url: 'https://www.pib.gov.in/RssMain.aspx?ModId=6&Lang=1&Regid=1', channel: 'India Govt', category: 'Government', language: EN, type: R },
  { name: 'Kremlin — Presidential news (English)', url: 'https://en.kremlin.ru/events/president/news/rss', channel: 'Russia Govt', category: 'Government', language: EN, type: R },
  { name: 'IRNA — English (Iran)', url: 'https://en.irna.ir/rss', channel: 'Iran Govt', category: 'Government', language: EN, type: R },
]
...
export const HINDI_CATEGORIES = ['General', 'Politics', 'Business', 'Sports', 'Newspaper', 'Digital', 'Government']
