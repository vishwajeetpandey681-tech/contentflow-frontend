          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start', gap: 6 }}>
              ...
              <p style={{ fontSize: 11, color: 'var(--text-dim)', margin: 0, maxWidth: 420, lineHeight: 1.45 }}>
                Off (recommended): only articles from <strong>your Sources</strong> appear in the inbox; Trends can still tag matching RSS items. On: also create new inbox rows from Google Trends story links.
              </p>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
